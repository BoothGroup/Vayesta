...
class HubbardEDMETTest_N10_U4_1imp_1occ(unittest.TestCase, HubbardEDMETTest):
    ...
    def setUpClass(cls):
        ...
        cls.mf.kernel()
        cls.edmet = edmet.EDMET(cls.mf, solver='EBFCI', fragment_type='site', bos_occ_cutoff=1)
...
class HubbardEDMETTest_N10_U4_1imp_10occ(unittest.TestCase, HubbardEDMETTest):
    ...
    def setUpClass(cls):
        ...
        cls.mf = lattmod.LatticeMF(cls.mol)
        cls.mf.kernel()
        cls.edmet = edmet.EDMET(cls.mf, solver='EBFCI', fragment_type='site', bos_occ_cutoff=10)
        f = cls.edmet.make_atom_fragment(0)
        symfrags = f.make_tsymmetric_fragments(tvecs=[10, 1, 1])
        cls.edmet.kernel()
...
class HubbardEDMETTest_N10_U4_2imp_2occ(unittest.TestCase, HubbardEDMETTest):
    ...
    def setUpClass(cls):
        ...
        cls.mf = lattmod.LatticeMF(cls.mol)
        cls.mf.kernel()
        cls.edmet = edmet.EDMET(cls.mf, solver='EBFCI', fragment_type='site', bos_occ_cutoff=2)
...
class HubbardEDMETTest_N6x6_U6_1x1imp_5occ(unittest.TestCase, HubbardEDMETTest):
    ...
    def setUpClass(cls):
        ...
        cls.mf = lattmod.LatticeMF(cls.mol)
        cls.mf.kernel()
        cls.edmet = edmet.EDMET(cls.mf, solver='EBFCI', fragment_type='site', bos_occ_cutoff=5)
        f = cls.edmet.make_atom_fragment(0)
