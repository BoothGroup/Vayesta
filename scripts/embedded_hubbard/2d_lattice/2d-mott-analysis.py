...
def plot_sc(name, quantity, clabel=None, ccolor=None, folder=None, abs_error=False, rel_error=False,):
    '''
    ...
    if name == 'DMRG':
        ...
        if folder is not None:
            filename = folder+dimension+'-'+quantity+'-'+name+'.txt'
        else:
        ...
        # Add potential customized label
...
#plot_sc('oneshot', 'energies-dm', folder='large_metal/', clabel='metal')
#plot_sc('pdmet', 'energies-dm', folder='large_metal/', clabel='metal')
#plot_sc('brueck', 'energies-dm', folder='large_metal/', clabel='metal')
plot_sc('vdmet', 'energies-dm', folder='large_metal/', clabel='metal')

#plot_sc('oneshot', 'energies-dm', folder='large_insulator/', clabel='insulator', ccolor='blue')
#plot_sc('pdmet', 'energies-dm',  folder='large_insulator/', clabel='insulator', ccolor='red')
#plot_sc('brueck', 'energies-dm',  folder='large_insulator/', clabel='insulator', ccolor='blue')
plot_sc('vdmet', 'energies-dm', folder='large_insulator/', clabel='insulator')
...
#plot_sc('oneshot', 'docc', folder='large_insulator/', clabel='insulator')
#plot_sc('pdmet', 'docc', folder='large_insulator/', clabel='insulator')
#plot_sc('brueck', 'docc', folder='large_insulator/', clabel='insulator')
