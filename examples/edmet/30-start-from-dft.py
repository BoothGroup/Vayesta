...
emb_lda.iao_fragmentation()
emb_lda.add_all_atomic_fragments()
emb_lda.kernel()
...
emb_b3lyp.iao_fragmentation()
emb_b3lyp.add_all_atomic_fragments()
emb_b3lyp.kernel()
...
emb_hf.iao_fragmentation()
emb_hf.add_all_atomic_fragments()
emb_hf.kernel()
