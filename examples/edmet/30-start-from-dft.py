...
emb_lda = vayesta.edmet.EDMET(
    lda, solver="CCSD-S-1-1", bath_options=dict(dmet_threshold=1e-12), oneshot=True, make_dd_moments=False
)
...
emb_b3lyp = vayesta.edmet.EDMET(
    b3lyp, solver="CCSD-S-1-1", bath_options=dict(dmet_threshold=1e-12), oneshot=True, make_dd_moments=False
)
...
emb_hf = vayesta.edmet.EDMET(
    hf, solver="CCSD-S-1-1", bath_options=dict(dmet_threshold=1e-12), oneshot=True, make_dd_moments=False
)
