...
with emb.iao_fragmentation() as f:
    ...
    f.add_atomic_fragment([0, 1, 2], orbital_filter=["O 2s", "3s", "4s"])
    ...
    f.add_atomic_fragment([0, 1, 2], orbital_filter=["O 2py", "O 2pz", "Se 2p", "3py", "3pz"])
    # All 4p states on Se and all px states (2px on O, 2-4px on Se)
    f.add_atomic_fragment(["Se", "O"], orbital_filter=["4p", "px"])
    # 3d states on Se
