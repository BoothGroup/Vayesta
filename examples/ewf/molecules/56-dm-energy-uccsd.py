...
print("E(RDM2, gg)=  %+16.8f Ha" % emb._get_dm_energy_old(global_dm1=True, global_dm2=True))
print("E(RDM2, gl)=  %+16.8f Ha" % emb._get_dm_energy_old(global_dm1=True, global_dm2=False))
print("E(RDM2, lg)=  %+16.8f Ha" % emb._get_dm_energy_old(global_dm1=False, global_dm2=True))
...
print("E(RDM2, gg)=  %+16.8f Ha" % emb._get_dm_corr_energy_old(global_dm1=True, global_dm2=True))
print("E(RDM2, gl)=  %+16.8f Ha" % emb._get_dm_corr_energy_old(global_dm1=True, global_dm2=False))
print("E(RDM2, lg)=  %+16.8f Ha" % emb._get_dm_corr_energy_old(global_dm1=False, global_dm2=True))
