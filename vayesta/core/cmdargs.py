...
def parse_cmd_args():
    ...
    # Log files
    parser.add_argument('-o', '--output-dir', default='.', help="directory for Vayesta output files [default: current working directory]")
    ...
    # Log level
    parser.add_argument('--log-level', type=int, default=DEFAULT_LOGLVL,
