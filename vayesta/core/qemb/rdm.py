...
def make_rdm1_ccsd(emb, ao_basis=False, symmetrize=True, partition=None, t_as_lambda=False, slow=False):
    ...
    if slow:
        ...
        l1 = (t1 if t_as_lambda else emb.get_t1(get_lambda=True, partition=partition))
